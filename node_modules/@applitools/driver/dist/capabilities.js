...
function extractCapabilitiesEnvironment(capabilities) {
    ...
    // Normalize keys in the capabilities' object
    if (!capabilities['platformName'] && capabilities['platform_name']) {
        capabilities['platformName'] = capabilities['platform_name'];
    }
    if (!capabilities['browserName'] && capabilities['browser_name']) {
        capabilities['browserName'] = capabilities['browser_name'];
    }
    const environment = {
...
function isMobile(capabilities) {
    ...
    return (capabilities.browserName === '' ||
        ...
        ['ios', 'android'].includes((_d = (_c = capabilities.platformName) === null || _c === void 0 ? void 0 : _c.toLowerCase()) !== null && _d !== void 0 ? _d : '') ||
