...
exports.populateConfigParams = exports.getConfig = void 0;
...
function getConfig({ baseDir = process.cwd(), paths = ['applitools.config.cjs', 'applitools.config.js', 'eyes.config.js', 'eyes.json'], params = [], traverse = { stopDir: os.homedir() }, strict, logger, } = {}) {
    ...
    populateConfigParams({ config, params });
    return config;
}
exports.getConfig = getConfig;
function populateConfigParams({ config, params = [] }) {
...
exports.populateConfigParams = populateConfigParams;
