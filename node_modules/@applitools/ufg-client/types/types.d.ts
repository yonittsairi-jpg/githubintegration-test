...
import { type UploadResource } from './resources/upload-resource';
...
export declare enum BrowserNameEnum {
    CHROME = "chrome",
...
export interface ChromeEmulationDeviceEnvironment {
    ...
    name?: 'chrome' | 'chrome-one-version-back' | 'chrome-two-versions-back';
}
