...
type AwaitableKnownResource = KnownResource & {
    ready: boolean | Promise<boolean>;
};
type getUrlForUrlResource = (url: string) => string;
export type Options = {
...
export type ProcessResourcesSettings = FetchResourceSettings & {
    ...
    getUrlForUrlResource?: getUrlForUrlResource;
};
export type ResourceMapping = Record<string, HashedResource | {
    errorStatusCode: number;
}>;
export declare function makeProcessResources({ fetchResource, uploadResource, cache, asyncCache, logger: mainLogger, }: Options): ProcessResources;
export {};
