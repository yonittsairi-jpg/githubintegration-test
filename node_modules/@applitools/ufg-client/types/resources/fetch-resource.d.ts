...
export declare function makeFetchResource({ accessToken, eyesServerUrl, apiKey, tunnelIds, concurrency, retryLimit, timeout, streamingTimeout, cache, fetch, logger: mainLogger, }: Options): FetchResource;
export {};
